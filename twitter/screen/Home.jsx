  ...
  return (
    <div style={{ height: "100vh", width: "100%" }} className='container-fluid layout '>
      ...
      <div className="row h-100 gx-0">
        <div className='col-2 d-flex p-3 flex-column sidebar'>
        ...
        <div className='col-6 p-3 feed overflow-x-hidden border    border-2'>
        ...
        <div className="col-4 mt-2 pt-3 p-2 rightbar">
