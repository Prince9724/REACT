...
const handleChart =()=>{
     localStorage.setItem("pro  duct",JSON.stringify(product));
     alert("local storage");    
}    
return (
        ...
        <div className="container justify-content-center d-flex flex-wrap">
            {
                Products.products.map((product)=> (
                    <div className='Card'>
                <img className='mb-3' src={product.images} alt="" />
                ...
                <div className='chart-btn'>
                   <div className='d-flex'>
                     <button className='btn btn-success'onChange={handleChart}>Chart</button>
