        ...
        <div id='project' className="project-box container-fluid">
            <div className='container p-5'>
                ...
                <div className="project-box d-flex gap-4 flex-wrap justify-content-center">
                    <div className='project border border-2 border-primary col-lg-4 col-md-5 col-12'>
                        <img className='img-fluid' src="https://i.ytimg.com/vi/PBcqGxrr9g8/maxresdefault.jpg" alt="" />
                        <div className='p-3'>
                     ...
                     <div className='project border border-2 border-primary col-lg-5 col-md-5 col-12'>
                     ...
                     <div className='project border border-2 border-primary col-lg-5 col-md-5 col-12'>
                        <img className='img-fluid' src="https://static.resumegiants.com/wp-content/uploads/sites/25/2022/06/09105622/Professional-portfolio-736x414.webp" alt="" />
                        <div className='p-3'>
